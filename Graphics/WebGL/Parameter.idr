...
instance MarshallToJType Parameter where
    toJType ActiveTexture                   = JEnum TextureUnit fromGLEnum
    ...
    toJType BlendDstAlpha                   = JEnum BlendFunc     fromGLEnum
    toJType BlendDstRGB                     = JEnum BlendFunc     fromGLEnum
    toJType BlendEquationAlpha              = JEnum BlendEquation fromGLEnum
    toJType BlendEquationRGB                = JEnum BlendEquation fromGLEnum
    toJType BlendSrcAlpha                   = JEnum BlendFunc     fromGLEnum
    toJType BlendSrcRGB                     = JEnum BlendFunc     fromGLEnum
    ...
    toJType CullFaceMode                    = JEnum Face fromGLEnum
    toJType CurrentProgram                  = JProgram
    toJType DepthBits                       = JInt
    toJType DepthClearValue                 = JFloat
    toJType DepthFunc                       = JEnum RelationFunc fromGLEnum
    ...
    toJType FrontFace                       = JEnum FrontFaceMode fromGLEnum
    toJType GenerateMipmapHint'             = JEnum HintTarget fromGLEnum
    ...
    toJType StencilBackFail                 = JEnum StencilOp fromGLEnum
    toJType StencilBackFunc                 = JEnum RelationFunc fromGLEnum
    toJType StencilBackPassDepthFail        = JEnum StencilOp fromGLEnum
    toJType StencilBackPassDepthPass        = JEnum StencilOp fromGLEnum
    ...
    toJType StencilFail                     = JEnum StencilOp fromGLEnum
    toJType StencilFunc                     = JEnum RelationFunc fromGLEnum
    toJType StencilPassDepthFail            = JEnum StencilOp fromGLEnum
    toJType StencilPassDepthPass            = JEnum StencilOp fromGLEnum
